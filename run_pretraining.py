...
flags.DEFINE_string(
    "input_file", "/home/zju/xlc/bert/finalAddress_L-12_H-768_A-12/data/finalData_whiteLine.tfrecord",
    "Input TF example files (can be a glob or comma separated).")

flags.DEFINE_string(
    "output_dir", "/home/zju/xlc/bert/finalAddress_L-12_H-768_A-12/test",
...
flags.DEFINE_integer("num_train_steps", 60000, "Number of training steps.")
...
flags.DEFINE_integer("max_eval_steps", 5000, "Maximum number of eval steps.")
